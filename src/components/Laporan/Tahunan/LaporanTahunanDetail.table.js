...
const LaporanTahunanDetailTable = ({
  tahunanData,
  total,
  handleDeleteJurnal,
}) => {
  return (
    <CardContent>
      <TableWrapper headers={tahunanData?.head} align="center">
        {tahunanData?.data?.map((data, index) => {
          return (
            <TableRow key={index}>
...
export default LaporanTahunanDetailTable;
