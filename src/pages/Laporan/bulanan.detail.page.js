...
import LaporanBulananDetailTable from "../../components/Laporan/Bulanan/LaporanBulananDetail.table";

const LaporanBulananDetail = () => {
  ...
  const [bulananData, setBulananData] = React.useState(null);
    ...
    <Box sx={{ p: 3 }}>
      <Card elevation={0}>
        ...
        >
          ...
          >
            Total Data : {bulananData?.data?.length}
          </Typography>
          <Typography
            variant="body1"
            sx={{ fontWeight: "700" }}
...
export default LaporanBulananDetail;
